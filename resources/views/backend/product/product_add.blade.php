                    ...
                    <div class="col-lg-8">
                        <div class="border border-3 p-4 rounded">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="mytextarea" class="form-control" id="mytextarea" rows="3"></textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <img style="margin-top: 15px;" src="" id="mainThmb" />
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row" id="preview_img" style="margin-top: 15px;"></div>
