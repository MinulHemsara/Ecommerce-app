                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('active.vendor.approve') }}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <textarea name="vendor_short_info" class="form-control">{{ $inactiveVendorDetails->vendor_short_info }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage"
                                                src="{{ isset($inactiveVendorDetails->photo) && !empty($inactiveVendorDetails->photo) ? asset('upload/vendor_images/' . $inactiveVendorDetails->photo) : asset('upload/admin_image/no_image.jpg') }}"
