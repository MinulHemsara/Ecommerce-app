                ...
                <div class="row mb-50 mt-30">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        ...
                        @endif
                            ...
                            <h2 class="title-detail" id="product_name">{{$product->product_name}}</h2>
                            ...
                            <div class="attr-detail attr-size mb-30">
                                ...
                                <select class="form-control unicase-form-control" id="size" required>
                            ...
                            <div class="attr-detail attr-size mb-30">
                                ...
                                <select class="form-control unicase-form-control" id="color" required>
                                    <option selected="" disabled="">--Choose Size--</option>
                        ...
                        <div class="tab-content shop_info_tab entry-main-content">
                            ...
                            <div class="tab-pane fade" id="Vendor-info">
                                <div class="vendor-logo d-flex mb-30">
                                    <img src="{{ (!empty($product->vendor->photo)) ? url('upload/vendor_images/'.$product->vendor->photo):url('upload/vendor_images/no_image.jpg')}} " alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                ...
                                <ul class="contact-infor mb-50">
                                    <li><img src="assets/imgs/theme/icons/icon-location.svg" alt="" /><strong>Address: </strong> <span>{{!empty($product['vendor']['address']) ? $product['vendor']['address'] : ""}}</span></li>
                                    <li><img src="assets/imgs/theme/icons/icon-contact.svg" alt="" /><strong>Contact Seller:</strong><span>{{!empty($product['vendor']['phone']) ? $product['vendor']['phone'] : ""}}</span></li>
                                </ul>
                                
                                <p>{{!empty($product['vendor']['vendor_short_info']) ? $product['vendor']['vendor_short_info'] : ""}}</p>
                            </div>
                                ...
                                <div class="product-cart-wrap hover-up">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{ route('product.details', ['id' => $product->id, 'slug' => $product->product_slug]) }}">
