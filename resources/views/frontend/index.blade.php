...
@section('main')
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                    <div class="product-img-action-wrap">
                                        ...
                                        <div class="product-action-1">
                                            ...
                                            <a aria-label="Quick view" class="action-btn" data-bs-toggle="modal" data-bs-target="#quickViewModal" id="{{ $product->id }}"
                                                onclick="productView({{ $product->id }})"><i class="fi-rs-eye"></i></a>
                                        </div>
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{ route('product.details', ['id' => $product->id, 'slug' => $product->product_slug]) }}">
    ...
    <section class="product-tabs section-padding position-relative">
            <div class="container">
                <div class="section-title style-2 wow animate__animated animate__fadeIn">
                    <h3>{{ !empty($skip_category_3->category_name) ? $skip_category_3->category_name : 'No' }} Category </h3>
                        ...
                        <div class="product-list-small animated animated">
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="{{ route('product.details', ['id' => $product->id, 'slug' => $product->product_slug]) }}"><img src="{{ asset($product->product_thambnail) }}" alt="" /></a>
                                </figure>
